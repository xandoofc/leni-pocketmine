...
abstract class Timings
{
	...
	public static TimingsHandler $permissibleDefault;
	...
	public static TimingsHandler $mobPathFinding;
	public static TimingsHandler $mobNavigationUpdate;
	public static TimingsHandler $mobBehaviorUpdate;
	...
	public static function init() : void
	{
		...
		self::$permissibleDefault = new TimingsHandler("Default Permission Calculation");
		...
		self::$mobPathFinding = new TimingsHandler("mobPathFinding");
		self::$mobNavigationUpdate = new TimingsHandler("mobNavigationUpdate");
		self::$mobBehaviorUpdate = new TimingsHandler("mobBehaviorUpdate");
	...
	public static function getDecodeDataPacketTimings(DataPacket $pk) : TimingsHandler
	{
	...
	public static function getHandleDataPacketTimings(DataPacket $pk) : TimingsHandler
	{
	...
	public static function getEncodeDataPacketTimings(DataPacket $pk) : TimingsHandler
	{

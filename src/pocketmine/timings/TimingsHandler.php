...
class TimingsHandler
{
	...
	{
		return self::lazyGetSet(self::$toggleCallbacks);
	}
	/**
	 * @phpstan-return ObjectSet<\Closure() : void>
	 */
	public static function getReloadCallbacks() : ObjectSet
	{
		return self::lazyGetSet(self::$reloadCallbacks);
	}
	/**
	...
	{
		return self::lazyGetSet(self::$collectCallbacks);
	}
	/**
	 * @return string[]
